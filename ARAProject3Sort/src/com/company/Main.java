...
public class Main {
    ...
    public static void app() throws IOException {
        String[] faceStringArray = {"чернокожая", "мулатка", "азиатка", "бледная кожа", "европейка"};
        String strBlush = "румянец широкой полосой, слеза, румянец крестиками, румянец сердечки, румянец ломаная, румянец черточки";
        String[] blushStringArray = strBlush.split(", ");

        String strHair = "черные волосы с седой прядью, черные волосы с розовой прядью, седые волосы, черные волосы с розой, черные кудри с сединой, зеленые кудри, черное каре с лотосом, каре синий градиент, каре красный градиент, волосы зеленый градиент, волосы фиолетовый градиент, голубые кудри, голубые волосы, афро куди, каштановые волосы, каре блонд, волосы блонд, желтое каре, желтые волосы, рыжее каре, рыжие кудри, черное каре, черные волосы, ядовито-розовое каре, ядовито-розовые волосы, нежно-розовое каре, нежно-розовые волосы";
        ...
        String strMouth = "веер, распиратор с фильтрами, распиратор, черная маска, медицинская маска, зеленый язык, красный язык, розовый язык, язык с пирсингом, обычный язык";
        String[] mouthStringArray = strMouth.split(", ");
        swap(mouthStringArray, 5, 8);
        swap(mouthStringArray, 6, 8);


        String strDrop = "слюнка у рта, капли у рта";
        String[] dropStringArray = strDrop.split(", ");

        String strEye = "глаза со стрелками, круглые глаза, обычные глаза";
        String[] eyeStringArray = strEye.split(", ");

        String strColor = "цвет глаз синий и зеленый, цвет глаз салатовый и голубой, цвет глаз желтый, цвет глаз карий, цвет глаз красный, цвет глаз радуждный, цвет глаз зеленый, цвет глаз фиолетовый, цвет глаз синий, цвет глаз салатовый, цвет глаз голубой";
        String[] colorStringArray = strColor.split(", ");
        swap(colorStringArray, 2, 3);
        swap(colorStringArray, 6, 7);

        String strDir = "кошачий взгляд, взгляд прямо, взгляд к носу, взгляд вверх";
        String[] dirStringArray = strDir.split(", ");

        String strGlass = "очки розовые сердечки, розовые очки, радужные маленькие очки, темные очки, черепаховые очки, радуждные очки, красные очки, круглые очки, золотые очки, смарт-очки";
        String[] glassStringArray = strGlass.split(", ");
        swap(glassStringArray, 8, 1);
        swap(glassStringArray, 3, 5);

        String strBrow = "одна бровь приподнята, брови полумесяцем, брови домиком";
        String[] browStringArray = strBrow.split(", ");

        String strTool = "питомец пришелец, питомец свинка, питомец Хатико, питомец лисичка, питомец рыжий кот, питомец серый кот, питомец мышонок, питомец панда, питомец мишка, питомец зайка, эмоция \"ня\", эмоция \"!\", эмоция \"смайл\", эмоция \"язык\", аксессуар малиновый чупачупс, аксессуар лимонный чупачупс, аксессуар леденец сердечко, аксессуар леденец, аксессуар попкорн, аксессуар классический айфон, аксессуар золотой айфон про, аксессуар серый айфон про, аксессуар синий айфон, аксессуар мятный айфон, аксессуар черный айфон, аксессуар красный айфон, аксессуар макбук бронза, аксессуар макбук серый космос, аксессуар макбук серебристый, аксессуар робот дроид, аксессуар гарнитура, аксессуар фотоаппарат";
        ...
        System.out.println(Image.listWithPictures.size());
...
////////////////////////////////////
                ...
                String str = "\r\n" + "picture " + count + "\r\n" + "face: " + faceStringArray[faceRandom] + "\r\n" + "hair: " + hairStringArray[hairRandom] + "\r\n" +
                        "mouth: " + mouthStringArray[mouthRandom] +
                        "\r\n" + "eye: " + eyeStringArray[eyeRandom] + "\r\n" + "eye_color: " + colorStringArray[eyeColorRandom] +
                        "\r\n" + "eye_dir: " + dirStringArray[eyeDirRandom];
                fileWriter.write(str);
                if (dropImage != null)
                    fileWriter.write("\r\n" + "drop: " + dropStringArray[dropRandom]);
                if (blushImage != null)
                    fileWriter.write("\r\n" + "blush: " + blushStringArray[blushRandom]);
                if (glassImage != null)
                    fileWriter.write("\r\n" + "glass: " + glassStringArray[glassRandom]);
                if (browImage != null)
                    fileWriter.write("\r\n" + "brow: " + browStringArray[browRandom]);
                if (toolImage != null)
                ...
                if (prob > 26.04)
                    fileWriter.write("\r\n" + "price: " + 0.01);
                else if (22.37 < prob && prob < 26.04)
                    fileWriter.write("\r\n" + "price: " + 0.02);
                else if (19.14 < prob && prob < 22.36)
                    fileWriter.write("\r\n" + "price: " + 0.03);
                else if (15.52 < prob && prob < 19.14)
                    fileWriter.write("\r\n" + "price: " + 0.04);
                else if (prob < 15.51)
                    fileWriter.write("\r\n" + "price: " + 0.05);
