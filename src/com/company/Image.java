...
public class Image {
    ...
    static double eye_color0_2Prob = 10;
    static double eye_color3_6Prob = 4;
    static double eye_color7_10Prob = 13.5;

    static double blushProb = 4.5;
    static double blushNullProb = 77;
    ...
    static double mouth1_4Prob = 2;
    static double mouth0Prob6 = 2;
    static double mouth5Prob = 3.2;
    static double mouth7_10Prob = 29;
    ...
    public static void image() throws IOException {
        ...
        while (i < 1000) {
            ...
            if (proportionColor < 4) {
                ...
                eyeColorRandom = (int) (3 + Math.random() * 5);
            else if(proportionColor == 7|| proportionColor==8)
                eyeColorRandom= 2;
            else
            ...
            if (proportionMouth < 7)
                mouthRandom = (int) (1 + Math.random() * 4);//mouth
            else if (proportionMouth >= 7 && proportionMouth < 11) {
                if (new Random().nextBoolean())
                    mouthRandom = 0;
                else
                    mouthRandom = 6;
            } else if(proportionMouth >= 11 && proportionMouth < 14)
                mouthRandom=5;
            else
...
/////////////////////////////////////////////////////////////////////////////
            ...
            if (eyeColorRandom == 0 || eyeColorRandom == 1 || eyeColorRandom==2)
                localList.add(eye_color0_2Prob);
            else if (eyeColorRandom > 2 && eyeColorRandom < 7)
                localList.add(eye_color3_6Prob);
            ...
            else if (mouthRandom > 0 && eyeColorRandom < 5)
                localList.add(mouth1_4Prob);
            else if (mouthRandom > 6)
                localList.add(mouth7_10Prob);
            else if(mouthRandom==5)
                localList.add(mouth5Prob);
